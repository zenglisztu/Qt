...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSOpenThreadENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSOpenThreadENDCLASS = QtMocHelpers::stringData(
    "OpenThread",
    "RecvDocx",
    "",
    "std::string&",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSOpenThreadENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSOpenThreadENDCLASS_t qt_meta_stringdata_CLASSOpenThreadENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "OpenThread"
        QT_MOC_LITERAL(11, 8),  // "RecvDocx"
        QT_MOC_LITERAL(20, 0),  // ""
...
Q_CONSTINIT static const uint qt_meta_data_CLASSOpenThreadENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject OpenThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_CLASSOpenThreadENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSOpenThreadENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSOpenThreadENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<OpenThread, std::true_type>,
        // method 'RecvDocx'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<std::string &, std::false_type>
    >,
...
void OpenThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OpenThread *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->RecvDocx((*reinterpret_cast< std::add_pointer_t<std::string&>>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject *OpenThread::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *OpenThread::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSOpenThreadENDCLASS.stringdata0))
        return static_cast<void*>(this);
    return QThread::qt_metacast(_clname);
}

int OpenThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QThread::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
